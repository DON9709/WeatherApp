...
final class MainViewController: UIViewController {
    ...
    private func renderWeather() {
        ...
        // Update regionCell with /weather-based current data
        if let current = mainViewModel.currentWeather {
            regionCell.update(with: current)
        }
        // Update hourly and weekly cells with /forecast-based data
        hourlyCell.update(items: mainViewModel.hourlyData)
        weeklyCell.update(items: mainViewModel.weeklyData)
    }
